...
#define STD_CONTAINER_ENUM_GET_AND_CHECK(V,IMPLEMENTS)	\
	(STD_UNUSED STD_CONTAINER_CALL_EXISTS(V,IMPLEMENTS), STD_CONTAINER_ENUM_GET(V))
...
#define STD_ITERATOR_ENUM_GET_AND_CHECK_SUB(IT,IMPLEMENTS,IMPVAR,GETVAR) \
	(	\
		sizeof(enum STD_FAKEVAR() {	\
			IMPVAR = STD_ITERATOR_PARENT_IMPLEMENTS_GET(IT), \
			GETVAR = STD_ITERATOR_ENUM_GET(IT) \
		}),		\
		STD_UNUSED STD_ITERATOR_CALL_EXISTS(IT,IMPLEMENTS,IMPVAR,GETVAR), \
		GETVAR	\
	)

#define STD_ITERATOR_ENUM_GET_AND_CHECK(IT,IMPLEMENTS) \
	STD_ITERATOR_ENUM_GET_AND_CHECK_SUB(IT,IMPLEMENTS, STD_FAKEVAR(), STD_FAKEVAR())
